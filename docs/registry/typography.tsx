...
const TYPEFACES = [
  ...
  },
  {
    ...
    sample: 'const color = var(--color-brand)',
...
font-family: var(--font-heading); /* Pangram — solo headings  */
font-family: var(--font-body);    /* Inter   — UI y body text */
font-family: var(--font-mono);    /* Roboto Mono — código     */
            ...
            {TYPEFACES.map(tf => (
              <div key={tf.name} style={{
                ...
                <div style={{
                  ...
                  {/* Role + weights */}
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                    <span style={{ fontFamily: 'var(--font-body)', fontSize: 12, fontWeight: 600, color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                      Rol · Pesos
                    </span>
                    <span style={{ fontFamily: 'var(--font-body)', fontSize: 13, color: 'var(--color-text-subtle)' }}>{tf.role}</span>
                  ...
                  {/* Description */}
                  <p style={{ fontFamily: 'var(--font-body)', fontSize: 13, color: 'var(--color-text-subtle)', lineHeight: 1.6, margin: 0 }}>
                    {tf.description}
                  </p>
                </div>
              </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontFamily: 'var(--font-body)' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid var(--color-border-subtle)' }}>
                  <th style={{ padding: '6px 12px', textAlign: 'left', fontSize: 11, fontWeight: 600, color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>Tamaño</th>
                  <th style={{ padding: '6px 12px', textAlign: 'left', fontSize: 11, fontWeight: 600, color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>px / lh</th>
                  {BODY_WEIGHTS.map(w => (
                    <th key={w.label} style={{ padding: '6px 12px', textAlign: 'left', fontSize: 11, fontWeight: 600, color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                      {w.label} · {w.weight}
                    </th>
                  ))}
                </tr>
              ...
              <tbody>
                {BODY_SIZES.map(size => (
                  <tr key={size.key} style={{ borderBottom: '1px solid var(--color-border-default)' }}>
