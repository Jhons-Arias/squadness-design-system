...
function BeforeAfter() {
  ...
  background-color: var(--sq-brand);          /* ✅ token */
...
const NAMING_ROWS = [
  { pattern: '--sq-brand',               example: '--sq-brand',                value: '#005fdb',              use: 'Color de acción principal' },
  { pattern: '--sq-text-[rol]',          example: '--sq-text-default',         value: '#020618',              use: 'Texto de alta jerarquía' },
  { pattern: '--sq-surface-[variante]',  example: '--sq-surface-default',      value: '#f8fafc',              use: 'Fondos de cards y paneles' },
  { pattern: '--sq-border-[variante]',   example: '--sq-border-subtle',        value: 'rgba(11,18,14,0.14)', use: 'Bordes de separación' },
  { pattern: '--sq-space-[escala]',      example: '--sq-space-300',            value: '24px',                 use: 'Padding, gap, margin' },
  { pattern: '--sq-font-[tipo]',         example: '--sq-font-body',            value: "'Inter'",              use: 'Familia tipográfica' },
  { pattern: '--sq-radius-[tamaño]',     example: '--sq-radius-sm',            value: '8px',                  use: 'Border-radius de componentes' },
]
...
const COLOR_TOKENS: TokenRow[] = [
  // Brand
  { name: '--sq-brand',                      value: '#005fdb',              preview: <Swatch color="#005fdb" />,                         use: 'Acción primaria, links activos' },
  ...
  // Text
  { name: '--sq-text-default',               value: '#020618',              preview: <Swatch color="#020618" />,                         use: 'Títulos, texto de alta jerarquía' },
  ...
  { name: '--sq-text-success',               value: '#3c6300',              preview: <Swatch color="#3c6300" />,                         use: 'Texto de mensajes de éxito' },
  ...
  // Surface
  { name: '--sq-surface-raised',             value: '#ffffff',              preview: <Swatch color="#ffffff" border />,                  use: 'Fondo de página y modals' },
  ...
  { name: '--sq-surface-brand-subtler',      value: '#cce2ff',              preview: <Swatch color="#cce2ff" border />,                  use: 'Avatar, botón de acción primaria' },
  ...
  // Border
  { name: '--sq-border-subtle',              value: 'rgba(11,18,14,0.14)', preview: <Swatch color="rgba(11,18,14,0.14)" border />,      use: 'Bordes de separación' },
  ...
  { name: '--sq-border-success',             value: '#5ea500',              preview: <Swatch color="#5ea500" />,                         use: 'Borde badge / alerta de éxito' },
      ...
      <div className="docs-main">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <Desc>
              Un token es una variable CSS con nombre semántico que reemplaza un valor literal. En lugar de escribir <code style={{ fontFamily: 'var(--sq-font-mono)', fontSize: 14, color: 'var(--sq-brand)', background: 'rgba(0,95,219,0.06)', padding: '1px 5px', borderRadius: 4 }}>#005fdb</code> directamente, usas <code style={{ fontFamily: 'var(--sq-font-mono)', fontSize: 14, color: 'var(--sq-brand)', background: 'rgba(0,95,219,0.06)', padding: '1px 5px', borderRadius: 4 }}>var(--sq-brand)</code>. Si el color cambia en el futuro, basta con actualizar el token — todos los componentes se actualizan solos.
            </Desc>
          </div>
          <BeforeAfter />
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <Desc>
              Todos los tokens siguen el patrón <co