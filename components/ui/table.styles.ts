export const TableStyles = `
  ...
  .sq-table-head .sq-table-checkbox {
    border-color: var(--sq-text-subtlest);
  }
  ...
  /* Alternating stripes: odd = surface/raised (var(--sq-surface-raised)), even = surface/default (var(--sq-surface-default)) */
  ...
  .sq-table-row--selected:hover {
    ...
    border-bottom: 1px solid var(--sq-brand-active);
  }
  ...
  .sq-table-row--expanded:hover {
    background: var(--sq-surface-neutral-subtlest);
    border-top: 1px solid var(--sq-brand);
    border-bottom: none;
  }
  ...
  .sq-table-action-btn--outline:hover {
    background: var(--sq-surface-neutral-subtler);
    border-color: var(--sq-border-bold);
  }

  .sq-table-action-btn--primary {
    background: var(--sq-surface-brand-subtler);
    border: none;
    color: var(--sq-brand);
  }

  .sq-table-action-btn--primary:hover {
    background: var(--sq-surface-brand-subtle);
  }
  ...
  .sq-table-expanded-row {
    background: var(--sq-surface-neutral-subtlest);
    border-bottom: 1px solid var(--sq-brand);
  }
